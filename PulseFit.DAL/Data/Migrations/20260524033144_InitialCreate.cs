        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CheckValidEmailConstraint", "Email Like '_0_%.%'");
                    table.CheckConstraint("CheckValidPhoneConstraint", "PhoneNumber Like '01%' and PhoneNumber Not Like '%[^0-9]%' ");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CheckValidEmailConstraint1", "Email Like '_0_%.%'");
                    table.CheckConstraint("CheckValidPhoneConstraint1", "PhoneNumber Like '01%' and PhoneNumber Not Like '%[^0-9]%' ");
                });
